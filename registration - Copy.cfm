<html>
	...
	<body>	
		<cfform id="form" name="form" method="post">
			              ...
			              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
			                ...
			                <form class="mx-1 mx-md-4" method="post" action="">
			                  ...
			                  <div class="d-flex flex-row align-items-center mb-4">
			                    ...
			                    <div class="form-outline flex-fill mb-0">
			                      <input type="password" id="password1" name="password1" onkeyup="javascript:checkpass()" class="form-control" required="yes"/>
			                  ...
			                  <div class="d-flex flex-row align-items-center mb-4">
			                    ...
			                    <div class="form-outline flex-fill mb-0">
			                      <input type="password" id="password2" onkeyup="javascript:checkpass()" name="password2" class="form-control" required="yes"/>
